...
CSV file (vinyl_website_data.csv) which can be uploaded directly to WooCommerce
via WP All Import.
"""
...
if input_xlsx_file:
    ...
    output_csv_file = f"./processed_data/Vinyl Website Data {str(datetime.datetime.today()).split()[0]}.csv"
